...
const heroQuotes = [
  'Aprender lleva tiempo, pero transforma para siempre.',
  'Ensenar bien tambien es disenar experiencias claras.',
  'La educacion es el movimiento de la oscuridad a la luz. - Allan Bloom',
  'Aula, comunidad y practica: el triangulo que sostiene el progreso.',
];
    ...
    <div className="min-h-screen bg-white">
      <section className="px-6 pt-20 pb-16 max-w-5xl mx-auto text-center">
        <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-gray-900 mb-6">
          Aprende con cursos online
          <span className="block text-blue-600 mt-2">de docentes reales</span>
        </h1>
        <p className="text-lg md:text-xl text-gray-600 mb-4 max-w-2xl mx-auto">
          Inscribite, mira las clases y avanza a tu ritmo.
          Cursos gratuitos y de pago, en un mismo campus.
        </p>
        <RotatingQuote quotes={heroQuotes} className="mb-10" />
        ...
        {!isAuthenticated && (
          <p className="mt-6 text-sm text-gray-500">
            Ya tenes cuenta? <Link to="/login" className="text-blue-600 hover:underline font-medium">Iniciar sesion</Link>
          </p>
        )}
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {loading ? (
            ...
            <div className="text-center text-gray-500 py-12 bg-white rounded-lg border-2 border-dashed border-gray-300">
              <p className="text-lg">Todavia no hay cursos publicados.</p>
              <p className="text-sm mt-2">Si sos docente, registrate y empeza a publicar.</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {courses.slice(0, 6).map((c) => (
                ...
                >
                  <div className="w-12 h-1.5 rounded-full bg-blue-600 mb-4" />
      ...
      <section className="px-6 py-16 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <h3 className="font-semibold text-lg text-gray-900 mb-2">Elegi tu curso</h3>
            <p className="text-gray-600 text-sm">Mira el catalogo y elegi el que mas te interese.</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">Si es gratis, entras al instante. Si es pago, abonas con Mercado Pago.</p>
          </div>
          <div className="text-center">
            ...
            <h3 className="font-semibold text-lg text-gray-900 mb-2">Avanza a tu ritmo</h3>
            <p className="text-gray-600 text-sm">Clases, materiales y seguimiento en un solo lugar.</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-16 bg-blue-600 text-white">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Sos docente?</h2>
          <p className="text-lg md:text-xl text-blue-100 mb-8">
            Publica tu curso, defini precios y acompana a tus estudiantes.
          </p>
          <Link
